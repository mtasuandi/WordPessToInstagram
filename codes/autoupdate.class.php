...
class PluginUpdateChecker_1_3 {
	 ...
	 */
	public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 1, $optionName = ''){
...
class PucFactory {
	 ...
	 */
	public static function buildUpdateChecker($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 1, $optionName = '') {
